...
#https://docs.google.com/spreadsheets/d/1VTgDXucVJgweqbLOcvifsOvo-Md8AkNQMjzx6wh4jAY/edit#gid=0
#https://docs.google.com/spreadsheets/d/スプレッドシートID/edit#gid=シートID
#スプレッドシートID 1VTgDXucVJgweqbLOcvifsOvo-Md8AkNQMjzx6wh4jAY
#シートID 0
...
#メッセージを受け取る・受け取ったら受け取ったテキストを返信する
    ...
    def message(line_event):
        ...
        if text == '勤怠出力':
            ...
            sheet = gc.open_by_key(SPREAD_SHEET_ID).sheet1
            # A1等のラベル指定して値取得
            ...
            for header in headers:
                column.append(item_dict[header])        
            # データの挿入
            sheet.append_row(column)
